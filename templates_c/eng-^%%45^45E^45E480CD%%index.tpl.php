<?php /* Smarty version 2.6.22, created on 2010-02-07 08:04:19
					...
					<tr>
						<td  bgcolor="#ffe503" valign="top" colspan="2">
							<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td valign="top"><img src="<?php echo $this->_tpl_vars['SITEURL']; ?>
images/new.jpg" width="179" height="41" /></td>
									<td width="22%" valign="top">&nbsp;</td>
									<td width="30%" valign="top"><img src="<?php echo $this->_tpl_vars['SITEURL']; ?>
images/work.jpg" width="179" height="41" /></td>
								</tr>
								<tr>
									<td valign="top"><br />
									...
									<td valign="top">&nbsp;</td>
									<td valign="top"><img src="<?php echo $this->_tpl_vars['SITEURL']; ?>
images/img.jpg" width="289" height="197" /></td>
								</tr>
								<tr>
									<td valign="top">&nbsp;</td>
