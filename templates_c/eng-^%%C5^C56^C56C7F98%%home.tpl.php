<?php /* Smarty version 2.6.22, created on 2010-02-15 10:29:00
         compiled from student/home.tpl */ ?>
			...
			<td style="background-color: rgb(122, 198, 190);" colspan="2">
				<table cellspacing="2" cellpadding="2" border="0" width="335">
				  <tbody><tr bgcolor="#d3f0cf">
					...
					<td width="211"><?php echo $this->_tpl_vars['student']['addmissionDate']; ?>
</td>
				  </tr>
				  <tr>
					<td><strong>Adminssion Number:</strong></td>
					<td><?php echo $this->_tpl_vars['student']['addmissionNo']; ?>
</td>
				  </tr>
				  <tr bgcolor="#d3f0cf">
					<td><strong>Class:</strong></td>
					<td><?php echo $this->_tpl_vars['student']['className']; ?>
</td>
				  </tr>
				  <tr>
					<td><strong>Class Roll No.:</strong></td>
					<td><?php echo $this->_tpl_vars['student']['studentId']; ?>
 </td>
				  </tr>
				  <tr bgcolor="#d3f0cf">
					<td><strong>Class Teacher Name:</strong></td>
					<td><?php echo $this->_tpl_vars['student']['teacherName']; ?>
</td>
				  </tr>
...
images/detail_top.jpg" width="324" height="43" /></td>
          ...
          <tr>
            <td class="loginbg"><table width="98%" border="0" cellspacing="0" cellpadding="6">
              <tr>
                ...
                <td width="40%" valign="top" ><?php echo $this->_tpl_vars['student']['addmissionDate']; ?>
</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td valign="top" >:</td>
                <td valign="top" ><?php echo $this->_tpl_vars['student']['addmissionNo']; ?>
</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td valign="top" >:</td>
                <td valign="top" ><?php echo $this->_tpl_vars['student']['className']; ?>
</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td valign="top" >:</td>
                <td valign="top" ><?php echo $this->_tpl_vars['student']['studentId']; ?>
</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td valign="top" >:</td>
                <td valign="top" ><?php echo $this->_tpl_vars['student']['teacherName']; ?>
</td>
              </tr>
          ...
          <tr>
            <td align="right" valign="top" class="loginbg"><span class="loginbg2"><a href="#"><img src="<?php echo $this->_tpl_vars['SITEURL']; ?>
images/send.jpg" width="35" height="16" border="0" /></a></span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
          <tr>
...
images/detailbtm.jpg" width="311" height="31" /></td>
          ...
          <tr>
            <td align="right"><img src="<?php echo $this->_tpl_vars['SITEURL']; ?>
images/student_info.jpg" width="311" height="40" /></td>
          </tr>
        </table></td>
      </tr>
    </table>
