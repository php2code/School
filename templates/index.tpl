					...
					<tr>
						...
						<div id="loginDiv" style="display:none" >
							<table width="280" border="0" cellpadding="0" cellspacing="0" class="login_table">
          						<tr>
            						<td bgcolor="#ffe503"><fieldset><legend><strong>Login</strong></legend>
										<table width="280" border="0" cellspacing="1" cellpadding="4">
											...
											<tr>
												...
												<td width="183" align="left">
													...
													<input type="text" name="username" id="username"  class="textbox_normal2" size="20" value="{$smarty.request.username}" />
												</td>
											</tr>
											...
											<tr>
												...
												<td width="183" align="left">
													<input type="password" id="password" name="password" class="textbox_normal2" size="20" />
												</td>
											</tr>
											<tr>
					...
					<tr>
						<td  bgcolor="#ffe503" valign="top" colspan="2">
							<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td valign="top"><img src="{$SITEURL}images/new.jpg" width="179" height="41" /></td>
									<td width="22%" valign="top">&nbsp;</td>
									<td width="30%" valign="top"><img src="{$SITEURL}images/work.jpg" width="179" height="41" /></td>
								</tr>
								<tr>
									<td valign="top"><br />
									...
									<td valign="top">&nbsp;</td>
									<td valign="top"><img src="{$SITEURL}images/img.jpg" width="289" height="197" /></td>
								</tr>
								<tr>
									<td valign="top">&nbsp;</td>
