					...
					<tr>
						<td  bgcolor="#ffe503" valign="top" colspan="2">
							<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td valign="top">
									<img src="{$SITEURL}images/new.jpg" width="179" height="41" /><br><br>
...
"><strong>Login</strong></legend>
													<table width="280" border="0" cellspacing="1" cellpadding="4">
														...
														<tr>
															...
															<td width="183" align="left">
																...
																<input type="text" name="username" id="username"  class="textbox_normal2" size="20" value="{$smarty.request.username}"  onkeypress="doEnter(event);"  />
															</td>
														</tr>
									...
									<img src="{$SITEURL}images/work.jpg" width="179" height="41" /><br><br>
									<img src="{$SITEURL}images/img.jpg" width="289" height="197" />
									</td>
								</tr>
								<tr>
									<td valign="top"><br />
