...
<table width="968" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td width="200" valign="top">{ include file = teacher/left_menu.tpl }</td>
...
<table width="100%" border="0" cellspacing="0">
    ...
    <tr>
		...
		<FORM ENCTYPE="multipart/form-data" ACTION="" METHOD="POST" name="frmCSV">
			...
			<input type="image" src="{$SITEURL}images/insertIntoDB.gif" name="buttoninsert"></td></tr></table>
			...
			<span class="style2">&#8226;</span> Download sample excel file &nbsp;&nbsp;<a href='download.php?file=xls'><img border="0" width='25' src='{$SITEURL}images/xls.jpg'></a> </p><br />
			<span class="style2">&#8226;</span>Download sample text file&nbsp;&nbsp;<a href='download.php?file=txt'><img border="0" width='25' src='{$SITEURL}images/text_logo.jpg'></a > </p>
        </form>	  </td>
    </tr>
    <tr>
