...
or install the Loader in the php.ini file.$nl";
	...
	if(extension_loaded('ionCube Loader')) {
	  echo "<strong>Successful!</strong>
	  The Loader was successfully installed and encoded files should be able to
...
are required to use encoded files on this system.${nl}";
	...
	echo "<strong>Successful!</strong>
	Run-time loading should be possible on your system.$nl$nl";
	echo "The $_os Loader for PHP $_php_family release is required.$nl";
      }
    }
  }
}
...
//have questions or require further assistance.$nl$nl";
